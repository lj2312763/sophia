  ...
  methods:{
    ...
    jump1(){
      if(this.path=="fenxi"){
        ...
        // location.href='https://www.yzsmart.top/ai/zip/open_source_services/cm5.1.3_x86_64.tar.gz';
         this.downloadUrl=window.config.url+'/ai/zip/open_source_services/'+"cm5.1.3_x86_64.tar.gz";
         //this.downloadUrl='https://www.yzsmart.top/ai/zip/open_source_services/cm5.1.3_x86_64.tar.gz';
        if(!sessionStorage.username){
          this.ifShowLogin = true;
        }else{
          location.href=this.downloadUrl;
    ...
    jump2(){
      if(this.path=="fenxi"){
         ...
         //window.open("https://www.yzsmart.top/kyfysm/大数据平台.pdf",'_blank');
