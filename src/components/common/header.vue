...
export default {
  ...
  computed:{
    user:function(){
      return this.$store.state['username'].username ? this.$store.state['username'].username : sessionStorage.username;
    },
    ifShowUser:function(){
      return this.$store.state['username'].username || sessionStorage.username ? true : false;
    }
  },
  components:{
  },
