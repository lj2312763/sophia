    ...
    <div class="aiSyntax" v-if="result">
        ...
        <div class="gif_product_show" v-if="ifShowDynmic">
            <div class="gif_img_container">
                ...
                <img :src="imgUrl+result.dynamicImageList[0].fileUrl" class="gif_img">
            </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    closeLoginWin(arg) {
      ...
      // var ifExist = sessionStorage.username;
      // if(ifExist){
    ...
    useNow() {
      // window.open('https://www.yzsmart.top/sophiaManager/sysindex.html#/','_blank');
      if(this.routeId == '7.4'){
