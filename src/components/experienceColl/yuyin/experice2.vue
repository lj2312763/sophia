      ...
      <div class="featur_function_exper">
        ...
        <div class="operat_container">
            <div class="operat_left">
                ...
                <div class="inputInfo">体验版本最多输入500个字</div>
            </div>
            <div class="operat_right">
                ...
                <div class="speed_speech">
                    <div>语速</div><Slider v-model="speed" :min='0' :max='10' :step='1' :disabled="isdisabled"></Slider><div>10</div>
                </div>
                <div class="volume">
                    <div>音量</div><Slider v-model="volume" :min='0' :max='10' :step='1' :disabled="isdisabled"></Slider><div>10</div>
                </div>
                <div class="readStyle">
                    <div>朗读风格</div>
...
export default {
  ...
  methods:{
    changeLanguage(v){
      ...
      switch (v) {
        case 'zh': 
          this.capKey = this.sex == 0 ? 'tts.cloud.wangjing' : 'tts.cloud.haobo'
          break;
        case 'en':
          this.capKey = this.sex == 0 ? 'tts.cloud.nancy' : 'tts.cloud.tom'
          break;
        case 'yue':
          this.capKey = 'tts.cloud.xiaojie'
          break;
        default:
    ...
    checkSex(arg){
        ...
        if(arg == 0){
            ...
            sexDom[2].style = 'opacity:0.6;background: #B8BECC;color:#3D4966;';
            sexDom[2].childNodes[2].style = 'color:#3D4966;';
            this.capKey = this.languageType == 'zh' ? 'tts.cloud.wangjing' : 'tts.cloud.nancy';
        }
        else if(arg == 1){
            ...
            this.capKey = this.languageType == 'zh' ? 'tts.cloud.haobo' : 'tts.cloud.tom';
        }
    },
    startBofang1(){
      if(this.isPlay){
    ...
    startBofang(){
      ...
      if(this.languageType == 'yue' && capKey == 'tts.cloud.xiaojie'){
        if(voiceStyle == '抑扬顿挫'){
          totalVoiceStyle = 'clear'
        }
      }
