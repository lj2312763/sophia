      ...
      for (var i = 0; i < dataArr.length; i++) {
        if (dataArr[i].word == "名词") {
            ...
            sortArr.forEach((item)=>{
                for (var attr in wordMapObj) {
                    if(item == wordMapObj[attr]){
                        totalminCiDataYArr.push(attr);
                        totalminCiDataXArr.push(wordMapObj[attr]);
                    }
                }
            })
            ...
            sortArr.forEach((item)=>{
                for (var attr in wordMapObj) {
                    if(item == wordMapObj[attr]){
                        totalDongciDataYArr.push(attr);
                        totalDongciDataXArr.push(wordMapObj[attr]);
                    }
                }
            })
            ...
            sortArr.forEach((item)=>{
                for (var attr in wordMapObj) {
                    if(item == wordMapObj[attr]){
                        totalXingrongciYDataArr.push(attr);
                        totalXingrongciXDataArr.push(wordMapObj[attr]);
                    }
                }
            })
