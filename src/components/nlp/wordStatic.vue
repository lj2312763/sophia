<template>
  <div class="nlp_container">
    ...
    <div class="nlp_content">
      ...
      <div class="textarea_container">
        ...
        <div class="textarea_info_content">
          <div class="info_text">0/100000</div>
    ...
    <div class="result_container" v-if="ifShowResult">
      ...
      <ciYun v-if="ifShowciyunResult" :ciyunChildData="ciyunData"></ciYun>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    wordCalcul() {
      ...
      var self = this;
      var ceshiBaseUrl = 'https://test.yzsmart.top:38443';
      this.$axios({
        method: "post",
