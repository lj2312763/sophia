<template>
  <div class="ciyun_fenlei_result_container">
    ...
    <div class="ciyun_fenlei_result_right">
      <div class="ciyun_fenlei_result_right_tubiao" v-show="ifShowCyun1">
        <div class="biaoge">
          ...
          <div class="shengc_btn">生成词云</div>
        </div>
        <div class="ciyun" id="zuanshiCiyunId"></div>
      </div>
      <div class="ciyun_fenlei_result_right_wenben" v-show="ifShowCyun2">
        <div class="biaoge">
          <div class="biaoge_content">
            <Table
              :border="showBorder"
      ...
      <div class="fenci_result_daochu_btn_container">
        <div class="fenci_result_daochu_btn">
