...
<div class="container" ref="contentContainer">
    <div class="banner_container">
        <Input v-model="inputText" placeholder="请输入您想要搜索的内容" @on-keyup.enter="aiSearch" style="height:40px">
            <Button slot="append" icon="ios-search" class="ico-btn" @click="aiSearch">智能搜索</Button>
        </Input>
